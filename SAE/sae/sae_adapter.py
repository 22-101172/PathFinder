...
from sae.cgpa_calculator import (
    compute_cgpa_per_semester,
    get_cgpa_display_data,
    simulate_cgpa,
    GRADE_POINTS,
)
from sae.providers.student_context_provider import FakeStudentContextProvider
from sae.providers.rules_provider import FakeRulesProvider
