...
def f_course_risk_analytics(
    ...
    """
    from sae.feature_engineering import GRADE_POINTS
...
def f_semester_difficulty(
    ...
    from sae.feature_engineering import compute_student_features
...
def f_prerequisite_bottleneck(
    student_id: str,
    registrations_df: "pd.DataFrame",
    curriculum_path: "str | Path" = Path(__file__).parent.parent / "engines" / "ale" / "rules" / "curriculum_2026.json",
) -> dict[str, Any]:
    """
...
def f_course_track_performance(
    ...
    """
    from sae.feature_engineering import GRADE_POINTS as _GP_TR
...
def f_course_category_performance(
    ...
    """
    from sae.feature_engineering import GRADE_POINTS as _GP_CAT
