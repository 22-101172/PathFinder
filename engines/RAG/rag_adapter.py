...
class RAGAdapter:
    ...
    def get_rule_bundles(self) -> dict[str, Any]:
        ...
        bundles["grading_scale"] = res_gs.get("data", {})
        ...
        bundles["graduation_rules"] = res_gr.get("data", {})
        ...
        bundles["warning_rules"] = res_wr.get("data", {})
        ...
        bundles["honors_rules"] = res_hr.get("data", {})
        ...
        bundles["credit_limit_rules"] = res_cl.get("data", {})
        ...
        bundles["retake_rules"] = res_rr.get("data", {})
        ...
        bundles["summer_rules"] = res_sr.get("data", {})
        ...
        bundles["student_level_rules"] = res_sl.get("data", {})
